...
// Get all SubtCateogry using  category Id 
...
//this function is responsible for preparing data necessary for editing a course
...
//It receives a request object containing information about the course to be updated. It extracts the course ID from the request.
...
// this method Update Image Course 
...
// the method to Update CourseVideo
...
//AddCourseLecture retrieves a course and its latest section based on the provided $id. It then returns a view, passing the retrieved course and section data to it. 
...
// this function is responsible for adding a new section to a course.
...
// this function is responsible for Saving a new section to a course
...
// this function is responsible for Edit a Lecture 
...
// this function is responsible for update a Lecture 
...
// this function is responsible for delete the Lecutre 
...
// to delete Section with All Lectures inside the Sections
