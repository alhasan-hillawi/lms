...
})->middleware(RedirectIfAuthenticated::class)->name('dashboard');
...
//Admin Group Middlweare

Route::middleware('auth','roles:admin')->group(function () {



    ///////// Admin Profile and Change password , Logout ////////////////
...
Route::controller(ReviewController::class)->group(function(){
 ...
 }); // END Instructor Group Middlweare
